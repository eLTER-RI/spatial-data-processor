...
for potential_site in sites_to_try:
    ...
    try:
        ...
        site_boundaries = gpd.read_file('shapefiles/deims/{}/raw/boundaries.shp.zip'.format(potential_site))
    except:
    ...
    try:
        ...
        nuts0 = gpd.read_file('shapefiles/deims/{}/composites/nuts2016/nuts0/boundaries.shp.zip'.format(potential_site))
        nuts1 = gpd.read_file('shapefiles/deims/{}/composites/nuts2016/nuts1/boundaries.shp.zip'.format(potential_site))
        nuts2 = gpd.read_file('shapefiles/deims/{}/composites/nuts2016/nuts2/boundaries.shp.zip'.format(potential_site))
        nuts3 = gpd.read_file('shapefiles/deims/{}/composites/nuts2016/nuts3/boundaries.shp.zip'.format(potential_site))
        # load into dict
        composites = {
                'nuts0': nuts0,
                'nuts1': nuts1,
    ...
    try:
        ...
        if metadata['nationalZonesAvailable']:
            ...
            for composite_dir in composite_dirs:
                # TODO
                # national composites can't be autogenerated yet, and so remain in original unzipped form
